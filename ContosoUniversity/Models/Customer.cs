...
namespace ContosoUniversity.Models
{
    public class Customer
    {
        ...
        [Column("bill_address_different", TypeName = "tinyint(4)")] //good to go
        ...
        [Column("is_not_export_contact", TypeName = "tinyint(1)")] //test
        public bool IsNotExportedContact { get; set; }
        [Column("is_registered_to_c4", TypeName = "tinyint(1)")] //test
        public bool IsRegisteredToC4 { get; set; }
        [Column("date_added", TypeName = "date")]  //TODO add default value = null OR make DateTime? (better)
        ...
        [Column("created_at", TypeName = "timestamp")] //CURENT_TIMESTAMP()
        public DateTimeOffset? CreatedAt { get; set; }
        [Column("updated_at", TypeName = "timestamp")] //CURENT_TIMESTAMP ON UPDATE CURENT_TIMESTAMP()
